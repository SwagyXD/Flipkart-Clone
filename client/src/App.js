...
const UpdateProfile = React.lazy(() =>
  import("./components/User/UpdateProfile")
);
...
const ProductTable = React.lazy(() =>
  import("./components/Admin/ProductTable")
);
...
const ReviewsTable = React.lazy(() =>
  import("./components/Admin/ReviewsTable")
);
